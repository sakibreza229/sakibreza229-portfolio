...
const Newsletter = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center md:justify-between items-center gap-x-12 gap-y-6 bg-secondary text-white px-6 lg:px-16 py-6 rounded-[4rem] text-center md:text-left">
      <div>
